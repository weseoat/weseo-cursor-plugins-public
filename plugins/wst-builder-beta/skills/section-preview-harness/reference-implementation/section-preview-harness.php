 ...
 * prefix_name). Dump a layout's structure (field names + types):
 ...
 * bootstrap file requires explicit user confirmation. After deploying to a new
 * environment, flush rewrites once:
